<template>
  ...
  <TableData
    v-model="getEmployees"
    v-model:selected="employeesSelected"
    v-model:total="getEmployees.total"
  />
  <FooterTable
...
onBeforeMount(() => {
  store.dispatch(acs.GET_EMPLOYEES_ACTION);
...
total.value = getEmployees.value.total;
