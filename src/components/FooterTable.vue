<template>
  <div class="footer-content">
    <div class="paging-control">
      <div
        class="btn-paging btn-first-page pointer"
        :class="page == 1 ? 'not-allowed' : ''"
        @click="goToFirstPage"
      />
      <div
        class="btn-paging btn-prev-page pointer"
        :class="page == 1 ? 'not-allowed' : ''"
      ...
      />
      <div
        class="btn-paging btn-next-page pointer"
        :class="page == maxPage ? 'not-allowed' : ''"
        @click="goToNextPage"
      />
      <div
        class="btn-paging btn-last-page pointer"
        :class="page == maxPage ? 'not-allowed' : ''"
        @click="goToLastPage"
      />
